...
class RestaurantView(ModelView):
    ...
    can_create = False
    column_list = ('id', 'name', 'category', 'image', 'dishes', 'tags',
                   'locations', 'editors', 'last_editor', 'last_edited')
...
class DishView(ModelView):
    ...
    column_list = ('id', 'name', 'price', 'image', 'beef', 'dairy', 'egg',
                   'fish', 'gluten', 'meat', 'nut', 'non_organic', 'pork',
                   'poultry', 'shellfish', 'soy', 'wheat', 'score',
                   'restaurant_id', 'editors', 'last_editor', 'last_edited')
...
class UserView(ModelView):
    ...
    can_create = False
    column_list = ('id', 'name', 'username', 'email', 'image', 'about',
                   'score', 'restaurants', 'dishes', 'is_admin', 'is_banned',
                   'last_edited', 'last_activity')
...
class LocationView(ModelView):
    ...
    can_create = False
    column_list = ('id', 'date', 'restaurant_id', 'api_id', 'lat', 'lng',
                   'address')
...
class IssueView(ModelView):
    ...
    can_create = True
    column_list = ('id', 'date', 'type', 'type_id', 'content')

    def __init__(self, session, **kwargs):
        super(IssueView, self).__init__(Issue, session, **kwargs)
...
admin.add_view(IssueView(db.session, name='Issues', category='Database'))
