...
def add_dish_using_add_dish_page(context, dish, restaurant):
    ...
    context.page = context.client.post('/restaurant/{}/add'.format(restaurant_id), data=dict(name=dish, price='0.00', image='', beef=True, dairy=True, egg=True, fish=True, gluten=True, meat=True, nut=True, non_organic=True, pork=True, poultry=True, shellfish=True, soy=True, wheat=True), follow_redirects=True)
...
def edit_dish_using_edit_dish_page(context, old_name, restaurant, new_name):
    ...
    context.page = context.client.post('/restaurant/{}/{}/edit'.format(restaurant_id, dish_id), data=dict(name=new_name, price='0.00', image='', beef=True, dairy=True, egg=True, fish=True, gluten=True, meat=True, nut=True, non_organic=True, pork=True, poultry=True, shellfish=True, soy=True, wheat=True), follow_redirects=True)
